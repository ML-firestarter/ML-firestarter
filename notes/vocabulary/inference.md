...
**Example:** in the [linear regression lesson](../04-foundations/02-linear-regression.md), finding $w$ and $b$ from the data is training. Using them to predict $y$ for a new $x$ is inference.
