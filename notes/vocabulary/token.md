...
Tokens are the unit behind many numbers you'll see: the size of a model's context window, the size of its training data ("trained on 15 trillion tokens") and API prices. In English, a token is about three quarters of a word on average.
...
**Related:** [Pretraining](pretraining.md) · [Base model](base-model.md) · [Inference](inference.md) · [Revenue model](revenue-model.md)
