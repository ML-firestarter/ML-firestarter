...
const en = {
  ...
  exams: {
    ...
    script: {
      ...
      // The certificate a pass earns, which the reader can publish.
      certificate: {
        title: 'Your certificate',
        offer:
          "Passing earns you a certificate for this chapter, signed by the site. Publish it to give it a page of its own that you can share: the page shows your GitHub name, the chapter, when you passed and your score, and the site's bot keeps the certificate in a public repository on GitHub.",
        publish: 'Publish your certificate',
        publishing: 'Publishing…',
        ready: 'Your certificate is published. Share its page, or add it to your GitHub profile or LinkedIn from there.',
        see: 'See your certificate',
        unpublish: 'Unpublish it',
        unpublishing: 'Unpublishing…',
        history:
          "Unpublishing takes its page down, but the certificate stays in the history of the public repository on GitHub. It's kept with your results too, so you can publish it again.",
        unpublished: 'Your certificate is no longer published.',
        outdated: 'This page is out of date. Reload it to publish your certificate.',
        notConfigured: "Certificates aren't set up on this site yet.",
      },
    },
  },
  ...
  certificates: {
    title: 'Certificate',
    description: 'A certificate for passing a chapter exam, signed by the site.',
    // The page without a certificate's id in its address.
    heading: 'Certificates',
    lede: 'Readers who pass a chapter exam get a certificate for it, signed by the site. Once they publish it, it has a page of its own, at an address they can share.',
    ...
    script: {
      ...
      missingLede: 'Check the address. Its reader may also have unpublished it.',
      invalid: "This certificate's signature doesn't check out",
      invalidLede: "The site didn't sign it, or it was changed after it was signed, so don't rely on it.",
      ...
      signature: {
        ...
        key: 'public key',
        noKey: "This copy of the site can't check the signature.",
        unsupported: "This browser can't check the signature.",
      },
      id: 'Certificate {id}',
      file: 'See it on GitHub',
      history: 'Check who published it',
      share: {
        ...
        // The certification's name on LinkedIn, where the site is its issuing organization.
        linkedinName: '{chapter}: chapter exam',
        manage: 'To take this page down, unpublish the certificate on the {exam}.',
        exam: "exam's page",
      },
    },
  },
...
const pl: typeof en = {
  ...
  exams: {
    ...
    script: {
      ...
      certificate: {
        ...
        offer:
          'Zaliczenie daje certyfikat z tego rozdziału, podpisany przez stronę. Opublikuj go, a dostanie własną stronę, którą możesz udostępnić: pokazuje ona Twoją nazwę na GitHubie, rozdział, datę zaliczenia i wynik, a bot strony przechowuje certyfikat w publicznym repozytorium na GitHubie.',
        publish: 'Opublikuj certyfikat',
        publishing: 'Publikowanie…',
        ready: 'Twój certyfikat jest opublikowany. Udostępnij jego stronę albo dodaj go stamtąd do profilu na GitHubie lub LinkedInie.',
        see: 'Zobacz certyfikat',
        unpublish: 'Cofnij publikację',
        unpublishing: 'Cofanie publikacji…',
        history:
          'Cofnięcie publikacji usuwa stronę certyfikatu, ale certyfikat zostaje w historii publicznego repozytorium na GitHubie. Zostaje też w Twoich wynikach, więc możesz opublikować go ponownie.',
        unpublished: 'Twój certyfikat nie jest już opublikowany.',
        outdated: 'Ta strona jest nieaktualna. Odśwież ją, aby opublikować certyfikat.',
        notConfigured: 'Certyfikaty nie są jeszcze skonfigurowane na tej stronie.',
      },
    },
  },
  ...
  certificates: {
    title: 'Certyfikat',
    description: 'Certyfikat zaliczenia egzaminu z rozdziału, podpisany przez stronę.',
    heading: 'Certyfikaty',
    lede: 'Po zaliczeniu egzaminu z rozdziału dostaje się certyfikat podpisany przez stronę. Po opublikowaniu ma on własną stronę pod adresem, który można udostępnić.',
    ...
    script: {
      ...
      missingLede: 'Sprawdź adres. Właściciel certyfikatu mógł też cofnąć jego publikację.',
      invalid: 'Podpis tego certyfikatu się nie zgadza',
      invalidLede: 'Strona go nie podpisała albo zmieniono go po podpisaniu, więc nie można na nim polegać.',
      ...
      signature: {
        valid: 'Podpisany przez stronę: podpis zgadza się z jej {key}.',
        key: 'kluczem publicznym',
        noKey: 'Ta kopia strony nie może sprawdzić podpisu.',
        unsupported: 'Ta przeglądarka nie może sprawdzić podpisu.',
      },
      id: 'Certyfikat {id}',
      file: 'Zobacz na GitHubie',
      history: 'Sprawdź, kto go opublikował',
      share: {
        title: 'Dodaj go do swoich profili',
        ...
        linkedin: 'Dodaj do profilu na LinkedInie',
        linkedinName: 'Egzamin z rozdziału: {chapter}',
        manage: 'Aby usunąć tę stronę, cofnij publikację certyfikatu na {exam}.',
        exam: 'stronie egzaminu',
      },
    },
  },
