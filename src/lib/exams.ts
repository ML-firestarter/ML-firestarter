 ...
 * read again, never which answers are right. Once they pass, readers can ask for a certificate
 * (lib/certificates.ts).
 */
import type { Covered } from './certificates.ts';
...
export interface ExamRecord {
  ...
  next?: string;
  /** Id of the reader's certificate for the exam, once they've asked for it. */
  certificate?: string;
}
 ...
 * - `not-passed`: a certificate was asked for an exam the reader hasn't passed.
 */
